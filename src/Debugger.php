...
use Yiisoft\Yii\Debug\PreventionPolicy\PreventionPolicyInterface;
...
final class Debugger
{
    ...
    public function __construct(
        ...
        array $collectors,
        private readonly ?PreventionPolicyInterface $startupPreventionPolicy = null,
    ...
    {
        if ($this->startupPreventionPolicy?->shouldPrevent($event)) {
            return;
        }
